...
Fingerpaint.prototype.login = function () {
  ...
  firebase.auth().onAuthStateChanged(function (user) {
    ...
    if (user != null) {
      //then user is not null, don't need to log in. 
      window.location.href = "home.html";
    }
  });
};
...
Fingerpaint.prototype.edit = function () {
  ...
  if (firebase.auth().currentUser != null) {
    ...
    firebase.auth().signInWithEmailAndPassword(firebase.auth().currentUser.email, old_pass).then(function (userCredential) {
