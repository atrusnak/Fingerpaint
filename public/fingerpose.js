    ...
    return function(t) {
        ...
        var d = function() {
            ...
            (n = [{
                ...
                value: function(t) {
                    ...
                    try {
                        for (i.s(); !(e = i.n()).done; ) {
                            var a, l = e.value, c = o.getPoints(l), f = [], s = [], h = u(c);
                            try {
                                for (h.s(); !(a = h.n()).done; ) {
                                    var d = a.value
                                      , p = t[d[0]]
                ...
                value: function(t) {
                    var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1
                      ...
                      , r = 0
                      , i = 0;
                    return t >= 75 && t <= 105 ? n = 1 * e : t >= 25 && t <= 155 ? r = 1 * e : i = 1 * e,
                    [n, r, i]
                }
            }, {
        ...
        var m = function() {
            ...
            (n = [{
                key: "estimate",
                value: function(t, e) {
                    var n, r = [], i = this.estimator.estimate(t), u = [], c = p(o.all);
                    try {
                        for (c.s(); !(n = c.n()).done; ) {
                            var f = n.value;
        ...
        function b(t, e) {
            return function(t) {
                ...
                var n = []
                  ...
                  , o = void 0;
                try {
                    for (var a, l = t[Symbol.iterator](); !(r = (a = l.next()).done) && (n.push(a.value),
                    !e || n.length !== e); r = !0)
                        ;
                } catch (t) {
                    i = !0,
        ...
        function w(t, e) {
            if (t) {
                ...
                "Map" === n || "Set" === n ? Array.from(n) : "Arguments" === n || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n) ? O(t, e) : void 0
            }
        }
        function O(t, e) {
            (null == e || e > t.length) && (e = t.length);
        ...
        R.addDirection(o.Thumb, l.DiagonalUpLeft, .25),
        R.addDirection(o.Thumb, l.DiagonalUpRight, .25);
